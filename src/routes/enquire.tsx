...
import enquireCover from "@/assets/enquire-cover.jpg.asset.json";

export const Route = createFileRoute("/enquire")({
  head: () =>
    buildHead({
      title: "Enquire | Lone Bull Rentals",
      description:
    ...
    <div className="page-fade bg-cream">
      ...
      <section className="grid md:grid-cols-2 min-h-[calc(100vh-8rem)]">
        <div className="relative aspect-[4/5] md:aspect-auto bg-mist overflow-hidden">
          <img src={enquireCover.url} alt="" className="absolute inset-0 w-full h-full object-cover" />
        </div>
