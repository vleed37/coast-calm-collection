...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Lone Bull Properties" },
      { property: "og:title", content: "Lone Bull Properties" },
      { name: "twitter:title", content: "Lone Bull Properties" },
      { name: "description", content: "Luxury self-catering holiday homes in St Helena Bay, on South Africa's West Coast. Ocean views, fully equipped and solar-powered, in Steenbergs Cove and Shelley" },
      { property: "og:description", content: "Luxury self-catering holiday homes in St Helena Bay, on South Africa's West Coast. Ocean views, fully equipped and solar-powered, in Steenbergs Cove and Shelley" },
      { name: "twitter:description", content: "Luxury self-catering holiday homes in St Helena Bay, on South Africa's West Coast. Ocean views, fully equipped and solar-powered, in Steenbergs Cove and Shelley" },
