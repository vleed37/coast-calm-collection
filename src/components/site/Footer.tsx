  ...
  return (
    <footer className="border-t border-mist py-24 text-center px-6">
      <div className="max-w-[1320px] mx-auto flex flex-col items-center gap-8">
        <div className="font-display text-4xl md:text-5xl tracking-[0.2em] font-light">Lone Bull Properties</div>
        ...
        <p className="smallcaps text-ink/50">© {new Date().getFullYear()} Lone Bull Properties. All rights reserved.</p>
      </div>
    </footer>
  );
}
